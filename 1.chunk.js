...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__shopping_list_routing__ = __webpack_require__(971);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shared_shared_module__ = __webpack_require__(961);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_forms__ = __webpack_require__(956);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shopping_list_add_component__ = __webpack_require__(970);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shopping_list_component__ = __webpack_require__(966);
...
var ShoppingListModule = (function () {
    ...
    ShoppingListModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__angular_core__["u" /* NgModule */])({
            declarations: [
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_0__shopping_list_routing__["a" /* ShoppingListRouting */]
            ]
        }), 
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__shopping_list_service__ = __webpack_require__(384);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(1);
...
var ShoppingListComponent = (function () {
    ...
    ShoppingListComponent.prototype.ngOnInit = function () {
        ...
        this.sls.onClear.subscribe(function (data) { return _this.selectedItem = data; });
    };
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__shopping_list_service__ = __webpack_require__(384);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__recipes_ingredients__ = __webpack_require__(386);
...
var ShoppingListAddComponent = (function () {
    ...
    ShoppingListAddComponent.prototype.onSubmit = function (ingredient) {
        var newIngredient = new __WEBPACK_IMPORTED_MODULE_1__recipes_ingredients__["a" /* Ingredients */](ingredient.name, ingredient.amount);
        if (!this.isAdd) {
    ...
    ShoppingListAddComponent.prototype.onDeleteItem = function () {
    ...
    __decorate([
        ...
        __metadata('design:type', (typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__recipes_ingredients__["a" /* Ingredients */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__recipes_ingredients__["a" /* Ingredients */]) === 'function' && _a) || Object)
    ], ShoppingListAddComponent.prototype, "item", void 0);
    ShoppingListAddComponent = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__angular_core__["v" /* Component */])({
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__shopping_list_component__ = __webpack_require__(966);
...
var ShoppingListRouting = __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* RouterModule */].forChild(SHOPPING_LIST_ROUTES);
...
module.exports = "<div class=\"row\">\n  <div class=\"col-xs-10\">\n    <rb-shopping-list-add [item]=selectedItem></rb-shopping-list-add>\n    <hr>\n    <ul class=\"list-group\">\n      <a class=\"list-group-item\" *ngFor=\"let item of items\" style=\"\" (click)=\"onSelectItem(item)\">{{item.name}}  ({{item.amount}})</a>\n    </ul>\n  </div>\n</div>"
